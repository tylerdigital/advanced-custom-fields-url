...
class acf_field_url extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*  var message = acf._e('url', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-url'),
		);
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-url', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-url');
		
		
		// register & include CSS
		wp_register_style( 'acf-input-url', "{$dir}css/input.css" ); 
		wp_enqueue_style('acf-input-url');
